...
for i in range(1, n_steps+2):
  ...
  plt.quiver(coord_x, coord_y, vel_x, vel_y)
  plt.axis(axrange)
  plt.title('$\eta=$'+str(eta)+'    step='+str(i).rjust(3,'0'))
  plt.tight_layout()
...
imageio.mimsave('simulation.gif', images, duration=0.01)   # combining all frame to make gif
for filename in filenames:
